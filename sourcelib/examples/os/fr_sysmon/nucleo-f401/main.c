...
//System monitor pins
#define SYSMON_CHAN0_PIN		3
#define SYSMON_CHAN0_GPIO		GPIOA
#define SYSMON_CHAN0_GPIO_CLK()	__GPIOA_CLK_ENABLE()

#define SYSMON_CHAN1_PIN		2
#define SYSMON_CHAN1_GPIO		GPIOA
#define SYSMON_CHAN1_GPIO_CLK()	__GPIOA_CLK_ENABLE()

#define SYSMON_CHAN2_PIN		10
#define SYSMON_CHAN2_GPIO		GPIOA
#define SYSMON_CHAN2_GPIO_CLK()	__GPIOA_CLK_ENABLE()
